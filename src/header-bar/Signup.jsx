        ...
        <div>
            <div className="flex flex-col mt-24 h-screen">
                <p className="my-8 px-8 flex justify-center text-xl">
                    Signing up will allow you to sign up and view volunteer
                    shifts and to register nativities.
                </p>
                <Formik
                    initialValues={{
                        fname: "",
                ...
                <dialog id="modal_signup" className="modal">
                    <div className="modal-box">
                        ...
                        <p className="py-4 text-lg">
                            Thank you for registering. Please feel free to sign
                            up for shifts as a volunteer.
                        </p>
                        <NavLink
                            to="/volunteer/setup"
