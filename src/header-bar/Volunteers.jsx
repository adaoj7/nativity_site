...
const {setupShift} = useLoaderData()
const allSetupTimes = setupShift.map(({shiftId,shiftDate,shiftTimeRange}) => {
  return ({
    id: shiftId,
    shiftDate,
    shiftTimeRange,
        ...
        <Form onSubmit={handleSubmit}>
          ...
          */}
          ...
          <ul role="group" aria-labelledby="checkbox-group">
            ...
            <span>
              <label>
              <Field type="checkbox" name="checked" value="O" />
              {`${values.setup[0].shiftTimeRange}`}
              </label>
            </span>
            <span>
